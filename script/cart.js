...
//   }
// }
const gamesInSorage = localStorage.getItem("dataStored");
...
leftCart.innerHTML += `
<h3>${parsedSrorage.name}</h3>
<img class="cart-image" src="${parsedSrorage.images[0].src}" alt="image of${parsedSrorage.name}" class="item-img">
`;
